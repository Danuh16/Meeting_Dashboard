  ...
  return (
    ...
    <div className="container flex ">
      <div className="flex flex-col gap-3 relative font-mono">
        ...
        <h2 className="bg-white p-4 cursor-pointer px-10 text-gray-500 text-lg rounded-xl" onClick={HandleAddMeeting}>
          
          Add Meeting
        </h2> {showAddMeeting && <AddMeeting onCloseAddMeeting={handleCloseAddMeeting}/>}
      </div>
    </div>
  );
};
