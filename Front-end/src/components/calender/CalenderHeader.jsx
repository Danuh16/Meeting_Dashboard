        ...
        <div className="flex justify-between">
          ...
          <div className="flex gap-4 pr-6">
            <div className="relative  ">
              <span
                className="absolute top-[1.1rem] justify-center transform -translate-y-1/2 left-2 text-green-700 font-bold leading-none"
            ...
            <div className="pt-1 bg-white flex justify-center rounded-full h-8 w-8">
              <RiBookmarkLine className="text-gray-500  gap-6" size={20} />
              <a href="http://"></a>
            </div>
            <div className="pt-1 bg-white flex justify-center rounded-full h-8 w-8 ">
              <RiEdit2Line
            ...
            <div className="pt-1 bg-white flex justify-center rounded-full h-8 w-8 ">
              <RiDeleteBinLine
                className="text-gray-500 text-[20px] text-center"
                size={20}
              />
              <a href="http://"></a>
            </div>
